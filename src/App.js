    ...
    <div className="App">
      <BrowserRouter>
        <div className="header">
          ...
          <NavLink exact activeClassName="active" to="/register">Registro</NavLink>
          <NavLink exact activeClassName="active" to="/login">Iniciar sesion</NavLink>
          <NavLink exact activeClassName="active" to="/premium-content">Contenido premium</NavLink>
        </div>
